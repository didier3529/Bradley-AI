...
export function ContractOverview() {
  ...
  // Update property access to match ContractAnalysisData structure
  const contract = analysis?.contracts?.[0]; // Get first contract from the array
  const securityScore = 85; // Default score since we don't have real analysis
  const vulnerabilities = 0; // Default since this is demo data
