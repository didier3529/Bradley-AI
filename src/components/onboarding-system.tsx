    ...
    return (
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Continue exploring Smart Block AI's features or modify your AI agent
            selection.
          </CardDescription>
        </CardHeader>
        <CardContent className="space-y-4">
          ...
          <div className="flex justify-end gap-2">
            ...
            {selectedDetails.length === 0 && (
              <Button onClick={() => setHasCompletedOnboarding(false)}>
                Select AI Agents
              </Button>
            )}
          </div>
        ...
        >
          {currentStep === "welcome" && (
            <div className="space-y-6">
              <Card>
                <CardHeader>
                  <CardTitle>Get Started with Smart Block</CardTitle>
                  <CardDescription>Your blockchain assistant</CardDescription>
                </CardHeader>
                <CardContent>
                  <p className="text-sm text-muted-foreground mb-4">
                    Welcome to Smart Block! Let's get you set up with everything
                    you need to start analyzing blockchain data.
                  </p>
                  <Button
                    onClick={() => handleStepComplete("wallet")}
                    className="w-full"
                  >
                    Start Tutorial
                  </Button>
